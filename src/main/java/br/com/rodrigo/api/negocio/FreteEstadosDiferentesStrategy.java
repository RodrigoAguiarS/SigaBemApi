...
@Service
public class FreteEstadosDiferentesStrategy implements CalculoFreteStrategy {
    ...
    public CotacaoFrete calcularFrete(double peso, String cepOrigem, String cepDestino, String nomeDestinatario) {
        ...
        LocalDate dataPrevistaEntrega = LocalDate.now().plusDays(ConstantesValores.DIAS_ENTREGA_ESTADOS_DIFRENTES);
